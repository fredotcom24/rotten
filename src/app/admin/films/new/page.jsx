...
export default function NewFilmPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('/api/admin/films', payload, {
      ...
      setError(err.response?.data?.error || 'Failed to create film')
      setUploading(false)
    }
  }
    ...
    <div className="min-h-screen bg-[#0b1320] py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-white">Create new film</h1>
        ...
        <div className="bg-[#020d18] border border-[#233a50] rounded-lg shadow p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              >
                {uploading ? 'Creating...' : 'Create film'}
              </button>
              <Link
                href="/admin/films"
